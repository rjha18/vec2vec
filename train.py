...
def main():
    ...
    opt = torch.optim.Adam(translator.parameters(), lr=cfg.lr, fused=False, betas=(0.0, 0.97))
    ...
    disc_opt = torch.optim.Adam(disc.parameters(), lr=cfg.disc_lr, eps=cfg.eps, betas=(0.0, 0.97))
    ...
    sup_disc_opt = torch.optim.Adam(sup_disc.parameters(), lr=cfg.disc_lr, eps=cfg.eps, betas=(0.0, 0.97))
    ...
    print(latent_disc)
    latent_disc_opt = torch.optim.Adam(latent_disc.parameters(), lr=cfg.disc_lr, eps=cfg.eps, betas=(0.0, 0.97))
    ######################################################################################
    ...
    similarity_disc_opt = torch.optim.Adam(similarity_disc.parameters(), lr=cfg.disc_lr, eps=cfg.eps, betas=(0.0, 0.97))
    ######################################################################################
